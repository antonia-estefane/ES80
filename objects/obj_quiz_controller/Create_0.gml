...
P_gan_n1 = [
	...
	"Independência, visto que os requisitos do cliente devem ser atendidos de forma individual, desconsiderando os requisitos anteriores;", "2"],
...
"Representa fielmente o produto final em termos de design.", "4"],
